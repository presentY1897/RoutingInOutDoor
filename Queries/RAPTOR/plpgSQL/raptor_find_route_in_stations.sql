            ...
            LOOP
                ...
                LOOP
                    IF rec.times[seq * 2] < deps[rec.stations[seq]].arr_time AND rec.times[seq * 2] > rec.times[seq * 2 - 1] THEN
                        deps[rec.stations[seq]] := create_trip(rec.route_desc_id, rec.stations[recs.station_seq], rec.stations[seq], recs.dept_time, rec.times[seq * 2], CAST(k AS DOUBLE PRECISION));
